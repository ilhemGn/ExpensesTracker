...
import 'package:expense_tracking_app/models/expense_bucket_model.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucketModel> get buckets {
    return [
      ...
      ExpenseBucketModel.forCategory(expenses, Category.study),
      ExpenseBucketModel.forCategory(expenses, Category.work),
      ExpenseBucketModel.forCategory(expenses, Category.sport),
    ];
  }
                ...
                .map(
                  (bucket) => Expanded(
                    child: Padding(
                      ...
                      child: Image.asset(
                        categoryImages[bucket.category]!,
                        height: 24,
                      ),
                    ),
                  ),
